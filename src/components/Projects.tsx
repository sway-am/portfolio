    ...
    >
      ...
      <div className="mx-auto w-full max-w-7xl relative z-10">
        ...
        <header className="mb-16 text-center">
          ...
          <h2 className="py-4 text-5xl sm:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-slate-900 via-emerald-700 to-slate-900 dark:from-slate-100 dark:via-emerald-400 dark:to-slate-100 mb-4">
            Projects
          </h2>
